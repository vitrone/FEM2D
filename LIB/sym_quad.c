...
static void quaecopy ( int nf, double xs[], double ys[], double ws[], double z[], 
  double w[] );

static void quaenodes ( int nptsout, double xsout[], double ysout[], double wsout[], 
  int nptsoutout, double xs2[], double ys2[], double ws2[] );


static void quaequad ( int itype, int mmax, double zs[], double whts[], int numnodes );

static void quaequad0 ( int mmax, int kk, double xnew[], double ynew[], double w[] );
static void quaerotate ( double xin, double yin, double *xout, double *yout );
static void r8vec_copy ( int n, double a1[], double a2[] );
static double r8vec_sum ( int n, double a[] );
static void rule01 ( double x[], double y[], double w[] );
static void rule02 ( double x[], double y[], double w[] );
static void rule03 ( double x[], double y[], double w[] );
static void rule04 ( double x[], double y[], double w[] );
static void rule05 ( double x[], double y[], double w[] );
static void rule06 ( double x[], double y[], double w[] );
static void rule07 ( double x[], double y[], double w[] );
static void rule08 ( double x[], double y[], double w[] );
static void rule09 ( double x[], double y[], double w[] );
static void rule10 ( double x[], double y[], double w[] );
static void rule11 ( double x[], double y[], double w[] );
static void rule12 ( double x[], double y[], double w[] );
static void rule13 ( double x[], double y[], double w[] );
static void rule14 ( double x[], double y[], double w[] );
static void rule15 ( double x[], double y[], double w[] );
static void rule16 ( double x[], double y[], double w[] );
static void rule17 ( double x[], double y[], double w[] );
static void rule18 ( double x[], double y[], double w[] );
static void rule19 ( double x[], double y[], double w[] );
static void rule20 ( double x[], double y[], double w[] );
static void rule21 ( double x[], double y[], double w[] );
static void rule22 ( double x[], double y[], double w[] );
static void rule23 ( double x[], double y[], double w[] );
static void rule24 ( double x[], double y[], double w[] );
static void rule25 ( double x[], double y[], double w[] );
static void rule26 ( double x[], double y[], double w[] );
static void rule27 ( double x[], double y[], double w[] );
static void rule28 ( double x[], double y[], double w[] );
static void rule29 ( double x[], double y[], double w[] );
static void rule30 ( double x[], double y[], double w[] );
static void rule31 ( double x[], double y[], double w[] );
static void rule32 ( double x[], double y[], double w[] );
static void rule33 ( double x[], double y[], double w[] );
static void rule34 ( double x[], double y[], double w[] );
static void rule35 ( double x[], double y[], double w[] );
static void rule36 ( double x[], double y[], double w[] );
static void rule37 ( double x[], double y[], double w[] );
static void rule38 ( double x[], double y[], double w[] );
static void rule39 ( double x[], double y[], double w[] );
static void rule40 ( double x[], double y[], double w[] );
static void rule41 ( double x[], double y[], double w[] );
static void rule42 ( double x[], double y[], double w[] );
static void rule43 ( double x[], double y[], double w[] );
static void rule44 ( double x[], double y[], double w[] );
static void rule45 ( double x[], double y[], double w[] );
static void rule46 ( double x[], double y[], double w[] );
static void rule47 ( double x[], double y[], double w[] );
static void rule48 ( double x[], double y[], double w[] );
static void rule49 ( double x[], double y[], double w[] );
static void rule50 ( double x[], double y[], double w[] );


static void trianmap ( int numnodes, double vert1[], double vert2[], double vert3[], 
  double rnodes[], double whts[] );

static void triasimp ( double x, double y, double *uout, double *vout );
static double triangle_area ( double vert1[], double vert2[], double vert3[] );
static int rule_full_size ( int mmax );
static int rule_compressed_size ( int mmax );
...
/*
  Purpose:
    ...
    FEM2D_SYMQ returns a symmetric quadrature formula for a user triangle.
...
*/
{
    debug_enter("degree of quadrature: %d", n);
    ...
    matlib_index numnodes = rule_full_size(n);
   
    matlib_index mcnt = 0;
    fem2d_err error;
    error = fem2d_create_cc(numnodes, xi);
    err_check( (error == FEM2D_FAILURE), clean_up,
               "Memory allocation for quadrature nodes (nr nodes: %d) failed!",
               numnodes);
    mcnt++;
    error = matlib_create_xv( numnodes, quadW, MATLIB_COL_VECT);
    err_check( (error == FEM2D_FAILURE), clean_up,
               "Memory allocation for quadrature weights (nr nodes: %d) failed!",
               numnodes);
    mcnt++;

    quaequad( itype, n, xi->elem_p, quadW->elem_p, numnodes );

    
    trianmap( numnodes, 
            (matlib_real*)(FEM2D_VERT + FEM2D_INDEX_V1 * FEM2D_DIM), 
            (matlib_real*)(FEM2D_VERT + FEM2D_INDEX_V2 * FEM2D_DIM), 
            (matlib_real*)(FEM2D_VERT + FEM2D_INDEX_V3 * FEM2D_DIM), 
            xi->elem_p, quadW->elem_p );
